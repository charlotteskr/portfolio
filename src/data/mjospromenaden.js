...
export const personas = [
  {
    ...
    needs: [
      'Kortfattet informasjon om hva som er på Mjøspromenaden',
      'Tydelig og lett navigering fra skysstasjonen',
      'Område som er mer adskilt',
      'Bilder av området på nett',
    ],
    challenges: [
      'Støy og mennesker gjør henne stresset',
      'Vet ikke om regler for området',
      'Blir lett forvirret og har dårlig oppmerksomhet',
      'Finner ikke info på Gjøvik kommune sin nettside',
    ],
  },
  {
    variant: 'p2',
    ...
    needs: [
      'Bekreftelse underveis i navigeringen',
      'Tilstrekkelig informasjon fra Google Maps',
      'En plass å henge med venner',
      'Informasjon og forutsigbare åpningstider',
    ],
    challenges: [
      'Vet lite om Gjøvik og er ikke kjent i byen',
      'Er avhengig/låst til telefonen for å navigere',
      'Er usikker på om det er lov å fiske ved Mjøspromenaden',
      'Vet ikke hvor toalettet ligger',
    ],
  },
];
